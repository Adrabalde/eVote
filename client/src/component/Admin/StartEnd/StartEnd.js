      ...
      <>
        ...
        {!this.state.elStarted & !this.state.elEnded ? (
          <div className="container-item info">
            <center>Les élections n'ont jamais été lancées.</center>
          </div>
        ) : null}
        <div className="container-main">
          <h3>Commencer ou terminer l'élection</h3>
          {!this.state.elStarted ? (
            <>
              <div className="container-item">
                <button onClick={this.startElection} className="start-btn">
                Commencer {this.state.elEnded ? "Again" : null}
                </button>
              </div>
              {this.state.elEnded ? (
                <div className="container-item">
          ...
          <div className="election-status">
            <p>A débuté: {this.state.elStarted ? "True" : "False"}</p>
            <p>Terminé: {this.state.elEnded ? "True" : "False"}</p>
          </div>
        </div>
      </>
    );
