        ...
        <div>
          {!this.state.isElStarted && !this.state.isElEnded ? (
            ...
            <div className="container-item attention">
              <center>
                <h3>L'élection se déroule au sein du mouvement.</h3>
                <p>Le résultat sera affiché une fois l'élection terminée.</p>
                <p>Allez-y et votez {"(if not already)"}.</p>
                <br />
                <Link
                  to="/Voting"
    ...
    return (
      <div className="container-winner">
        <div className="winner-info">
          <p className="winner-tag">Gagnant(e)!</p>
          <h2> {winner.header}</h2>
          <p className="winner-slogan">{winner.slogan}</p>
        </div>
        <div className="winner-votes">
          <div className="votes-tag">Total des votes: </div>
  ...
  return (
    <>
      ...
      <div className="container-main" style={{ borderTop: "1px solid" }}>
        <h2>Resultats</h2>
        <small>Candidats totaux: {candidates.length}</small>
        {candidates.length < 1 ? (
          <div className="container-item attention">
            <center>Aucun candidat.</center>
          </div>
        ) : (
          <>
